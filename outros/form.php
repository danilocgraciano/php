<form method="POST">
    ...
    <input type="hidden" id="id" name="id" value="<?php echo $tarefa['id']; ?>">

    <div class="form-group row">
        <label for="nome" class="col-sm-2 col-form-label">Nome</label>
        <div class="col-sm-10">
            <input type="text" class="form-control form-control-sm" id="nome" name="nome" value="<?php echo $tarefa['nome']; ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
        <textarea class="form-control fomr-control-sm" id="descricao" name="descricao" rows="3"><?php echo $tarefa['descricao']; ?></textarea>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control form-control-sm" id="prazo" name="prazo" value="<?php echo traduz_data_para_exibir($tarefa['prazo']); ?>">
